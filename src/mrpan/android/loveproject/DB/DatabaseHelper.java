...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS User(user_id integer primary key autoincrement, user_name varchar(50),user_password varchar(200),user_nick text,user_sex INTEGER,user_sign varchar(300),user_info varchar(500),user_photo blob,user_level integer,time_last date)");   
